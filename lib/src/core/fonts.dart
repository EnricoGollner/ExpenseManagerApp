...
TextStyle get labelStyle => const TextStyle(fontSize: 15, fontWeight: FontWeight.bold);
...
TextStyle get valueTextStyle => const TextStyle(fontSize: 14, color: colorPrimary, fontWeight: FontWeight.w600);
